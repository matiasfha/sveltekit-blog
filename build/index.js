...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-a5548042.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-a5548042.js", "/./_app/chunks/vendor-1d986b6d.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-ede74623.js", "css": ["/./_app/assets/pages/__layout.svelte-00781ee8.css"], "js": ["/./_app/pages/__layout.svelte-ede74623.js", "/./_app/chunks/vendor-1d986b6d.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-d9a2832a.js", "css": [], "js": ["/./_app/error.svelte-d9a2832a.js", "/./_app/chunks/vendor-1d986b6d.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-a15aff19.js", "css": [], "js": ["/./_app/pages/index.svelte-a15aff19.js", "/./_app/chunks/vendor-1d986b6d.js"], "styles": null }, "src/routes/blog/[uid].svelte": { "entry": "/./_app/pages/blog/[uid].svelte-b2f269d5.js", "css": ["/./_app/assets/pages/blog/[uid].svelte-3898185e.css"], "js": ["/./_app/pages/blog/[uid].svelte-b2f269d5.js", "/./_app/chunks/vendor-1d986b6d.js"], "styles": null } };
...
var ArticleCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="${"flex flex-row items-center justify-between transform duration-150 hover:shadow-md"}"><a${add_attribute("href", `/blog/${article.uid}`, 0)}><img class="${"object-scale-down w-28 h-28"}"${add_attribute("src", article.image.url, 0)}${add_attribute("alt", PrismicDOM.RichText.asText(article.title), 0)}></a>
	<div class="${"flex flex-col ml-4 items-start justify-around"}"><a${add_attribute("href", `/blog/${article.uid}`, 0)}><h1 class="${"text-gray-900 text-base mt-4"}">${escape2(PrismicDOM.RichText.asText(article.title))}</h1></a>
		<span class="${"text-gray-500 text-sm"}">${escape2(date)}</span></div></article>`;
});
...
function load$1({ fetch: fetch3 }) {
  return __awaiter$1(this, void 0, void 0, function* () {
    const url = `/api/blog/articles.json`;
    const res = yield fetch3(url);
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="${"w-full"}"><div class="${"container max-w-6xl py-12 mx-auto"}"><article class="${"grid grid-cols-2 gap-4"}"><div><a${add_attribute("href", `/blog/${featured.uid}`, 0)}><img${add_attribute("alt", PrismicDOM.RichText.asText(featured.title), 0)}${add_attribute("src", featured.image.url, 0)} class="${"bg-contain object-contain shadow-sm"}"></a></div>
			<div><h2 class="${"text-sm uppercase text-gray-600"}">Editor&#39;s Pick</h2>
				<a${add_attribute("href", `/blog/${featured.uid}`, 0)}><h1 class="${"text-3xl text-gray-900"}">${escape2(PrismicDOM.RichText.asText(featured.title))}</h1></a>
...
<section class="${"w-full py-8"}"><div class="${"container max-w-6xl py-12 mx-auto"}"><div class="${"grid grid-cols-3 gap-8"}"><article class="${"flex flex-col"}"><a${add_attribute("href", `/blog/${listHeader.uid}`, 0)}><img${add_attribute("alt", PrismicDOM.RichText.asText(listHeader.title), 0)}${add_attribute("src", listHeader.image.url, 0)} class="${"m-0 pb-4 w-full h-52 object-fill"}"></a>
				<a${add_attribute("href", `/blog/${listHeader.uid}`, 0)}><h1 class="${"text-gray-900 text-xl mb-4"}">${escape2(PrismicDOM.RichText.asText(listHeader.title))}</h1>
				</a>s
...
var ssr = true;
var prerender = true;
function load({ fetch: fetch3, page }) {
  return __awaiter(this, void 0, void 0, function* () {
    const { uid } = page.params;
    const url = `/api/blog/${uid}.json`;
    const res = yield fetch3(url);
...
<main class="${"w-full pb-4"}"><header class="${"post-header w-full bg-gray-900 flex items-start flex-col justify-center relative max-h-96 h-96 svelte-11j33vu"}"><img${add_attribute("src", article.image.url, 0)} class="${"object-cover w-full absolute top-0 left-0 z-0 max-h-96 filter blur-sm"}"${add_attribute("alt", title, 0)}>
		<h1 class="${"text-center text-gray-100 font-bold text-3xl max-w-4xl z-10 p-8"}">${escape2(title)}</h1></header>
	<article class="${"text-gray-800 text-base text-left py-12 mx-auto container max-w-6xl "}">${PrismicDOM.RichText.asHtml(article.content)}</article>
</main>`;
});
